...
class TestCitationVerifier:
    ...
    def mock_pubmed_response(self):
        ...
        <PubmedArticleSet>
            <PubmedArticle>
                <MedlineCitation>
                    <Article>
                        <ArticleTitle>EEG for epilepsy diagnosis</ArticleTitle>
                        <Abstract>
    ...
    @patch('src.eeg_rag.verification.citation_verifier.httpx.AsyncClient')
    ...
    def test_check_claim_support_no_model(self, verifier):
        ...
        supported, score = result
        assert supported is True  # Should default to True
