...
def render_rag_basics():
    ...
    <div style="background: #E3F2FD; 
                border-radius: 8px; padding: 1.25rem; margin-bottom: 1.25rem; border: 1px solid #BBDEFB;">
        <p style="color: #1F2937; font-size: 1rem; line-height: 1.7; margin: 0; word-wrap: break-word;">
...
def render_eeg_domain():
    ...
    <div style="background: #E8F5E9; 
                border-radius: 8px; padding: 1.25rem; margin-bottom: 1.25rem; border: 1px solid #C8E6C9;">
        <p style="color: #1F2937; margin: 0; line-height: 1.6; word-wrap: break-word;">
...
def render_query_strategies():
    ...
    <div class="researcher-tip">
        ...
        <div class="tip-content" style="line-height: 1.6; word-wrap: break-word;">
...
def render_interpreting_results():
    ...
    st.markdown(
        """
    <div style="background: #F5F7F9; 
                border-radius: 8px; padding: 1.25rem; margin-bottom: 1.25rem; border: 1px solid #E8EAED;">
        <p style="color: #1F2937; margin: 0; line-height: 1.6; word-wrap: break-word;">
...
def render_limitations():
    ...
    <div style="background: #FFF8E1; 
        ...
        <h4 style="color: #E65100; margin-bottom: 0.75rem; font-size: 1.1rem;">⚠️ Important Limitations</h4>
        <p style="color: #4E342E; margin: 0; line-height: 1.6; word-wrap: break-word;">
