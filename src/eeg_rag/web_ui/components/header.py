...
def render_header():
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="display: flex; gap: 2rem;">
                <div style="text-align: center;">
                    ...
                    <div style="font-size: 0.75rem; color: #6B7280; text-transform: uppercase;">{paper_label}</div>
                </div>
                <div style="text-align: center;">
    ...
    if is_demo:
        st.info("📥 **Demo Mode**: Only 10 sample papers are indexed. Run `python scripts/run_ingestion.py` to collect 1,000+ real papers from PubMed and arXiv.")
