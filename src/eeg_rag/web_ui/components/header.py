    ...
    <div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%);
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                ...
                <p style="color: #a0a0c0; margin: 0.5rem 0 0 0; font-size: 1rem;">
            ...
            <div style="display: flex; gap: 2rem;">
                <div style="text-align: center;">
                    ...
                    <div style="font-size: 0.75rem; color: #888; text-transform: uppercase;">Papers Indexed</div>
                </div>
                <div style="text-align: center;">
                    <div style="font-size: 1.75rem; font-weight: 700; color: #10B981;">8</div>
                    <div style="font-size: 0.75rem; color: #888; text-transform: uppercase;">AI Agents</div>
                </div>
                <div style="text-align: center;">
                    <div style="font-size: 1.75rem; font-weight: 700; color: #F59E0B;">99.2%</div>
                    <div style="font-size: 0.75rem; color: #888; text-transform: uppercase;">Citation Accuracy</div>
                </div>
            </div>
        </div>
    </div>
