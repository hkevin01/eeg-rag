...
def render_feedback_panel():
    ...
    <div class="researcher-tip">
        ...
        <div class="tip-content">
            ...
            <strong>📧 Contact:</strong> <a href="mailto:kevin.hildebrand@gmail.com" style="color: #1565C0;">kevin.hildebrand@gmail.com</a>
        </div>
    </div>
    """,
    ...
    feedback_tabs = st.tabs(
        ["⭐ Rate Results", "🐛 Report Issue", "💡 Suggest Feature", "📜 View History"]
    )
...
def render_result_rating():
    ...
    with col1:
        ...
        accuracy = st.slider(
            "✓ Accuracy", 1, 5, 3, help="How accurate was the information provided?"
        )
    ...
    with col2:
        ...
        clarity = st.slider(
            "📝 Clarity", 1, 5, 3, help="Was the response easy to understand?"
        )
        usefulness = st.slider(
            "💡 Usefulness", 1, 5, 3, help="How useful was this for your research?"
        )
    ...
    if st.button("Submit Rating", type="primary", use_container_width=True):
        rating_data = {
            ...
            "overall": round(
                (relevance + accuracy + completeness + citations + clarity + usefulness)
                / 6,
                2,
            ),
    ...
    if st.button("Submit Issue Report", type="primary", use_container_width=True):
        ...
        issue_data = {
            ...
            "query": (
                ...
                if include_query and st.session_state.get("query_history")
                else None
            ),
...
def render_feature_suggestion():
    ...
    feature_title = st.text_input(
        "Feature Title", placeholder="Brief title for your suggestion"
    )
